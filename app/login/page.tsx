...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-3 py-4 sm:px-4 sm:py-6 bg-gradient-to-br from-purple-50 via-purple-100 to-purple-200">
      <Card className="w-full max-w-[380px] sm:max-w-[480px] shadow-lg border-border/50 backdrop-blur-sm">
        <CardHeader className="space-y-2 sm:space-y-3 pb-3 sm:pb-5 px-4 sm:px-7 pt-4 sm:pt-7">
          <div className="flex items-center justify-center gap-1.5 sm:gap-2.5 mb-0.5 sm:mb-2">
            ...
            />
            <span className="text-base sm:text-xl font-bold leading-tight">SEO Reporting</span>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-3.5 sm:space-y-5">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              ...
              <Input
                ...
                disabled={loading}
                autoComplete="email"
                className="h-9 sm:h-11 text-sm px-3"
            ...
            <div className="space-y-1.5 sm:space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-9 sm:h-11 pr-10 text-sm px-3"
                  aria-invalid={error ? "true" : "false"}
                  aria-describedby={error ? "login-error" : undefined}
                />
                <button
            ...
            <Button 
              type="submit" 
              className="w-full h-9 sm:h-11 text-sm font-medium cursor-pointer mt-4 sm:mt-6 touch-manipulation" 
              disabled={loading}
            >
              {loading ? (
                <>
